...
import 'detailed_event_awareness_model.dart';
export 'detailed_event_awareness_model.dart';

class DetailedEventAwarenessWidget extends StatefulWidget {
  const DetailedEventAwarenessWidget({
    Key? key,
    this.getDetails,
  }) : super(key: key);
  ...
  @override
  _DetailedEventAwarenessWidgetState createState() =>
      _DetailedEventAwarenessWidgetState();
}

class _DetailedEventAwarenessWidgetState
    extends State<DetailedEventAwarenessWidget> {
  late DetailedEventAwarenessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailedEventAwarenessModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<EventsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final detailedEventAwarenessEventsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
