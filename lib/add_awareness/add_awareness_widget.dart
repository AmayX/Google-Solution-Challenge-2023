...
import 'add_awareness_model.dart';
export 'add_awareness_model.dart';

class AddAwarenessWidget extends StatefulWidget {
  const AddAwarenessWidget({Key? key}) : super(key: key);

  @override
  _AddAwarenessWidgetState createState() => _AddAwarenessWidgetState();
}

class _AddAwarenessWidgetState extends State<AddAwarenessWidget> {
  late AddAwarenessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAwarenessModel());
                              ...
                              child: TextFormField(
                                ...
                                onFieldSubmitted: (_) async {
                                  final eventsCreateData =
                                      createEventsRecordData(
                                    description:
                                        _model.organiserController.text,
                                  );
                                  await EventsRecord.collection
                                      .doc()
                                      .set(eventsCreateData);
