...
class AddtreeWidget extends StatefulWidget {
  const AddtreeWidget({Key? key}) : super(key: key);

  @override
  _AddtreeWidgetState createState() => _AddtreeWidgetState();
}
            ...
            SingleChildScrollView(
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(12.0, 8.0, 0.0, 12.0),
                    child: Container(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  final eventsCreateData = createEventsRecordData(
                    ...
                    name: _model.organiserController.text,
